...
def set_mlflow_tracking():
    ...
    if "MLFLOW_TRACKING_URI" not in os.environ:
        logger.warning("MLFLOW_TRACKING_URI is not set in environment variables. Using default URI.")
        os.environ["MLFLOW_TRACKING_URI"] = "https://dagshub.com/nithinyanna3/taxi_project.mlflow/" 
